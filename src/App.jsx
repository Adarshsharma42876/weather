...
function App() {
  ...
  return (
    <div className="min-h-screen p-3 md:p-10 bg-gradient-to-br to-red-500 from-white dark:from-gray-300 dark:to-black bg-cover bg-center">
      <div className="flex flex-wrap w-full h-full dark:bg-opacity-50 rounded-2xl dark:bg-slate-50 bg-orange-300 bg-opacity-50">
